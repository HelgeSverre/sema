...
Sema has editor plugins for VS Code, Vim/Neovim, Emacs, Helix, and Zed. All plugins provide syntax highlighting for the full standard library (460+ functions), special forms, keyword literals, character literals, strings, numbers, comments, and LLM primitives.
...
- Full syntax highlighting (special forms, 460+ builtins, LLM primitives, keywords, character literals, comments)
...
- Syntax highlighting (special forms, 460+ builtins, LLM primitives, keyword literals, booleans, `nil`, strings, comments)
- Smart auto-pairs for `()`, `[]`, `{}`, `""`
