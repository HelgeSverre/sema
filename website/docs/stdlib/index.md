...
Sema ships with **570+ built-in functions** across **25 modules**, covering everything from string manipulation and file I/O to HTTP requests, regex, and cryptographic hashing.
