...
- **Phase 9:** XXX tests pass, all providers support tool calling

## Phase 9: LLM SDK Completeness

| Step | What                                                                                    | Status |
| ---- | --------------------------------------------------------------------------------------- | ------ |
| 1    | Gemini tool-call support (function calling)                                             | Done   |
| 2    | Ollama tool-call support                                                                | Done   |
| 3    | Auto-retry with backoff on rate limiting                                                | Done   |
| 4    | HTTP timeouts on all providers (120s)                                                   | Done   |
| 5    | Provider introspection: `llm/set-default`, `llm/list-providers`, `llm/current-provider` | Done   |
| 6    | Budget control: `llm/set-budget`, `llm/clear-budget`, `llm/budget-remaining`            | Done   |
| 7    | Slash-namespaced accessor renames with legacy aliases                                   | Done   |
| 8    | `conversation/say` options (`:temperature`, `:max-tokens`, `:system`)                   | Done   |

468 tests total (75 reader + 386 integration + 7 sema-reader), all passing.
