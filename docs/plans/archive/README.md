...
| `2026-02-24-living-code-phase4.md` | Retired 2026-06-20 — Layer 6 runtime self-modification (`observe!`/`become!`/`evolve` etc.) killed for good; non-deterministic + unmaintainable, never ported off the retired tree-walker. PR #30 closed. See `docs/deferred.md` ("LC"). Docstrings (`doc`/`meta`) salvaged separately; doctests dropped as YAGNI. |
